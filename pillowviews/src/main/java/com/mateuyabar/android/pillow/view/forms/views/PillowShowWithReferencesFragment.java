...
public class PillowShowWithReferencesFragment<T extends IdentificableModel> extends PillowShowFragment<T>{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		int id = com.mateuyabar.android.pillow.views.R.id.reserver_id_for_list_fragment;
		frame.setId(id);
		linearlayout.addView(frame);
		
		Fragment listFragment = PillowView.getInstance(getActivity()).getViewConfiguration(referencedClass).getListFragment();
