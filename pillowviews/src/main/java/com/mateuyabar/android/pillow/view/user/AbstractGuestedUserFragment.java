...
public abstract class AbstractGuestedUserFragment<T extends IdentificableModel & IGuestedUser> extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final Listeners.ErrorListener errorListener = new CommonViewListeners.ErrorListenerWithNoConnectionToast(getActivity());
	...
	private class LogListener extends CommonViewListeners.DummyToastListener{
