...
import cat.my.android.pillow.data.users.GuestedUser;
import cat.my.android.pillow.data.users.GuestedUserDataSource;
 ...
 * @param <T>
 */
public abstract class GuestedUserFragment<T extends IdentificableModel & GuestedUser> extends Fragment {

    public GuestedUserFragment(Class<T> userClass){
